...
ActiveRecord::Schema.define(version: 2019_05_26_131447) do
  ...
  create_table "badges", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "method"
    t.index ["method"], name: "index_badges_on_method", unique: true
  ...
  create_table "tests", force: :cascade do |t|
    ...
    t.integer "passage_time", default: 30, null: false
